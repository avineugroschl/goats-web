...
const SOCIAL_LINKS = [
  ...
  {
    name: "Facebook",
    href: "https://www.facebook.com/goatspickupbasketballapp",
    ...
    <footer className="border-t border-white/[0.05] bg-[#242424]">
      <div className="mx-auto max-w-7xl px-6 py-12 sm:px-12">
        <div className="flex flex-col items-center gap-6">
          <span className="wordmark text-sm text-white/80">G.O.A.T.S</span>
        ...
        <div className="mt-8 flex flex-col items-center gap-4 border-t border-white/[0.05] pt-6 sm:flex-row sm:justify-between">
          <span className="text-xs text-white/20">&copy; 2026 Eclipsis... All rights reserved.</span>
